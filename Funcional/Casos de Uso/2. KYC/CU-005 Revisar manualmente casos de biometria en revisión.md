...
| **Flujo principal** | 1. El analista consulta el listado de casos "en revisión".<br>2. El analista revisa la información biométrica del caso.<br>3. El analista registra su decisión: continuar o rechazar.<br>4. El sistema actualiza el estado de la solicitud según la decisión registrada. |
