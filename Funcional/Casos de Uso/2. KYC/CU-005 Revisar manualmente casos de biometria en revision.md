...
| **Historias de usuario relacionadas** | [HU-022](../../Historias De Usuario/2. KYC/HU-022 Revisi�n Biometria.md) (Resolver manualmente casos de biometría en revisión) (Resolver manualmente casos de biometría en revisión) |
...
| **Referencias** | Fuente: ficha [HU-022](../../Historias De Usuario/2. KYC/HU-022 Revisi�n Biometria.md) (Resolver manualmente casos de biometría en revisión) — *Historias de Usuario — Fliipa*, carpeta "2. KYC" (repositorio `documentacion_fliipa`, María Fernanda Herazo). |
