...
| **Descripción** | *(Diseño, no vigente hoy — coherente con CU-004 pendiente.)* El analista de riesgo revisaría manualmente los casos de biometría marcados "en revisión" para decidir si el cliente puede continuar el proceso de solicitud. |
...
| **Flujo principal** | *(Flujo de diseño, no vigente hoy)* 1. El analista consultaría el listado de casos "en revisión".<br>2. El analista revisaría la información biométrica del caso.<br>3. El analista registraría su decisión: continuar o rechazar.<br>4. El sistema actualizaría el estado de la solicitud según la decisión registrada. |
