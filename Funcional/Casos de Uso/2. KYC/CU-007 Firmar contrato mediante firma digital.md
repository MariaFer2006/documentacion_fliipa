...
| **Historias de usuario relacionadas** | HU-009 (Firmar contrato mediante firma digital con proveedor externo) |
...
| **Referencias** | Fuente: ficha HU-009 — *Historias de Usuario — Fliipa*, carpeta "2. KYC" (repositorio `documentacion_fliipa`, María Fernanda Herazo). |
