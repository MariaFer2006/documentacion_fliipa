...
| **Flujo principal** | 1. El sistema presenta al cliente el paso de validación biométrica. 2. El cliente completa el proceso de biometría con el proveedor externo, desde el dispositivo disponible (celular, computador u otro). 3. El proveedor externo procesa la validación. 4. El sistema registra el resultado (aprobado, rechazado o en revisión) asociado a la solicitud. |
