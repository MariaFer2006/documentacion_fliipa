...
| **Flujo principal** | 1. El administrador busca al cliente por número de documento. 2. El sistema muestra hasta 500 registros de auditoría del cliente (línea de crédito, desembolsos, pagos). 3. Si negocio autorizó un ajuste excepcional, el administrador modifica el cupo o el día de corte de la línea de crédito. 4. El sistema valida que el día de corte esté en el rango de 1 a 31. 5. El sistema registra la acción en auditoría. |
...
| **Historias de usuario relacionadas** | HU-031 (Buscar cliente y ver historial auditado), HU-032 (Ajustar cupo o fecha de corte) |
