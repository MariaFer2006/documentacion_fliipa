...
| **Historias de usuario relacionadas** | HU-033 (Simular plan de pago con distintas tasas) |
...
| **Referencias** | Fuente: ficha HU-033 — *Historias de Usuario — Fliipa*, carpeta "6. Gestión Plataforma del admin" (repositorio `documentacion_fliipa`, María Fernanda Herazo). |
