...
| **Flujo principal** | 1. El administrador de sistema ingresa al panel de monitoreo.<br>2. El sistema muestra la latencia y disponibilidad del core bancario.<br>3. El sistema muestra la latencia y disponibilidad de Cloud SQL.<br>4. El administrador identifica incidentes o degradaciones a partir de estos indicadores. |
