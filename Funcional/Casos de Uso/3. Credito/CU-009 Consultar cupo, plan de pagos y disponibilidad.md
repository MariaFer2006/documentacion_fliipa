...
| **Flujo principal** | 1. El cliente ingresa al portal de usuarios. 2. El sistema valida el estado de la línea de crédito del cliente. 3. Si el estado es Aprobado o Activa, el sistema muestra cupo disponible, plan de pagos y movimientos. |
...
| **Historias de usuario relacionadas** | HU-010 (Consultar cupo, plan de pagos y movimientos), HU-011 (Ver mensaje de no disponibilidad de crédito) |
