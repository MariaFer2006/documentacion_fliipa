...
| **Flujo principal** | 1. El cliente solicita un código de compra desde la plataforma. 2. El sistema genera u obtiene el código (QR/cupón) asociado al cliente. 3. El cliente presenta el código en el punto de venta D1. 4. El punto de venta valida el código. 5. El sistema aplica el cupo a la compra. |
