...
| **Historias de usuario relacionadas** | HU-024 (Ver cartera segmentada por bucket de mora)<br>HU-025 (Registrar cada interacción de cobranza)<br>HU-026 (Tablero semanal de priorización del Comité de Cartera) |
