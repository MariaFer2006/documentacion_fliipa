...
| **Historias de usuario relacionadas** | [HU-025](../../Historias%20De%20Usuario/4.%20Cobranza/HU-025%20Registrar%20cada%20interacci%C3%B3n%20de%20cobranza.md) (Registrar cada interacción de cobranza) |
| **Estado en plataforma** | El registro de interacciones de cobranza está completamente implementado (`collection-notes.ts`, incluyendo resumen de atención). |
| **Referencias** | Fuente: ficha [HU-025](../../Historias%20De%20Usuario/4.%20Cobranza/HU-025%20Registrar%20cada%20interacci%C3%B3n%20de%20cobranza.md) — *Historias de Usuario — Fliipa*, carpeta "4. Cobranza" (repositorio `documentacion_fliipa`, María Fernanda Herazo). |
