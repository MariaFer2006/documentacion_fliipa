...
| **Flujos alternativos / excepciones** | A1.Si el cliente no cumpliera las condiciones del bucket para ningún alivio, el caso continuaría el flujo estándar de cobranza (ver [CU-012](CU-012%20Gestionar%20y%20registrar%20cartera%20y%20cobranza.md)) o escalaría a jurídico (ver [CU-021](CU-021%20Escalar%20casos%20a%20cobro%20juridico.md)). |
