...
| **Descripción** | El cliente accede a alivios (abono parcial, congelamiento de intereses o condonación) cuando tiene dificultades temporales de pago, según las condiciones y topes definidos por bucket de mora, y estas decisiones se apoyan en el tablero semanal del Comité de Cartera (ver  [CU-012](CU-012%20Gestionar%20y%20registrar%20cartera%20y%20cobranza.md)) |
...
| **Flujos alternativos / excepciones** | A1. El cliente no cumple las condiciones del bucket para ningún alivio: el caso continúa el flujo estándar de cobranza (ver [CU-012](CU-012%20Gestionar%20y%20registrar%20cartera%20y%20cobranza.md)) o escala a jurídico (ver [CU-021](CU-021%20Escalar%20casos%20a%20cobro%20juridico.md)). |
