...
| **Flujos alternativos / excepciones** | A1. La cuenta Druo del cliente no está conectada o vigente. <br> A2. el crédito no es candidato a débito automático hasta reconectarla. <br> A3.El sistema envía solicitud de conexión a Druo y reintenta al día siguiente enviando una alerta operativa (ver [CU-024](../6. Operaci�n Admin/CU-024 Ver y reconectar la cuenta Druo del cliente.md)). |
...
| **Reglas de negocio** | El débito automático es un proceso ejecutado por el sistema sobre cartera vencida, distinto del prepago voluntario por PSE (ver [CU-011](CU-011 pagar y gestionar cuotas del credito .md)), aunque ambos usarían Druo como conector bancario. |
| **Historias de usuario relacionadas** | [HU-014](../../Historias De Usuario/4. Cobranza/HU-014 Debito autom�tico de cr�ditos vencidos.md) (Débito automático de créditos vencidos) |
...
| **Referencias** | Fuente: ficha [HU-014](../../Historias De Usuario/4. Cobranza/HU-014 Debito autom�tico de cr�ditos vencidos.md) — *Historias de Usuario — Fliipa*, carpeta "4. Cobranza" (repositorio `documentacion_fliipa`, María Fernanda Herazo). |

> **Nota de versión (2026-08-27):** Caso de uso nuevo, creado al separar el CU-011 original (v1.0 del catálogo), que combinaba el pago voluntario por PSE y el débito automático de créditos vencidos en una sola ficha. El pago voluntario por PSE permanece en [CU-011](CU-011 pagar y gestionar cuotas del credito .md). Se asigna el consecutivo CU-026 por ser el siguiente disponible tras CU-025; se recomienda validarlo con negocio antes de considerarlo definitivo.
