...
| **Flujo principal** | 1. (Prepago) El cliente inicia el pago de su cuota en cualquier momento antes de la fecha de corte, mediante PSE. 2. El sistema refleja el pago en el plan de pagos y en el cupo disponible del cliente. 3. (Débito automático) El sistema identifica los créditos vencidos candidatos a débito automático según las reglas de cartera. 4. El sistema ejecuta el débito conforme a las reglas definidas y registra el resultado del intento. |
| **Flujos alternativos / excepciones** | A1. El pago por PSE no se completa: la cuota permanece pendiente. A2. La cuenta Druo del cliente no está conectada o vigente: el crédito no es candidato a débito automático hasta reconectarla (ver CU-024). |
...
| **Historias de usuario relacionadas** | HU-013 (Prepagar la cuota por PSE), HU-014 (Débito automático de créditos vencidos) |
...
| **Referencias** | Fuente: fichas HU-013 y HU-014 — *Historias de Usuario — Fliipa*, carpeta "4. Cobranza" (repositorio `documentacion_fliipa`, María Fernanda Herazo). |
