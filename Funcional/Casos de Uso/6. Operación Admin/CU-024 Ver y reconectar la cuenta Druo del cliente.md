...
| **Historias de usuario relacionadas** | [HU-040](../../Historias De Usuario/5. Operaci�n admin/HU-040  Ver y reconectar cuenta Dr�o.md) (Ver y reconectar la cuenta Druo del cliente)<br>*relacionada con:*<br>[HU-014](../../Historias De Usuario/4. Cobranza/HU-014 Debito autom�tico de cr�ditos vencidos.md) (débito automático, aún pendiente de punta a punta)|
...
| **Referencias** | Fuente: ficha  [HU-040](../../Historias De Usuario/5. Operaci�n admin/HU-040  Ver y reconectar cuenta Dr�o.md) — *Historias de Usuario — Fliipa*, carpeta "6. Gestión Plataforma del admin" (repositorio `documentacion_fliipa`, María Fernanda Herazo). |
