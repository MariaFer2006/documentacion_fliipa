...
| **Historias de usuario relacionadas** | HU-016 (Atención inicial por asistente virtual con IA)<br>HU-017 (Escalar a agente humano cuando la IA no resuelve el caso)<br>HU-028 (Recibir el caso escalado con contexto completo)<br>HU-029 (Validar identidad en casos críticos) |
