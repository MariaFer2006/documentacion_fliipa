...
| **Flujo principal** | 1. El cliente se comunica con soporte indicando que olvidó su PIN o que su cuenta está bloqueada. 2. El agente de servicio al cliente verifica la situación de la cuenta (intentos de acceso, bloqueo). 3. El agente ayuda al cliente a generar un nuevo PIN o a desbloquear la cuenta. 4. El cliente recupera el acceso a su cupo. |
