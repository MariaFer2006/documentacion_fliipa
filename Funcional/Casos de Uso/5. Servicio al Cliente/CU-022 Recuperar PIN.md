...
> **Nota de versión (2026-08-28):** este caso de uso se separó del CU-022 original, que combinaba recuperar el PIN y desbloquear la cuenta en una sola ficha. El desbloqueo de cuenta ahora vive en [CU-027](CU-%20034%20desbloquear%20la%20cuenta.md), ya que son disparadores distintos (olvido de PIN vs. bloqueo por intentos fallidos), aunque ambos requieren la intervención del agente de servicio al cliente.