...
| **Flujo principal** | 1. El sistema envía un código OTP por WhatsApp. 2. El cliente ingresa el código recibido. 3. El sistema valida el código. 4. El sistema envía un segundo código OTP por correo electrónico. 5. El cliente ingresa el código recibido. 6. El sistema valida el código y permite continuar al siguiente paso del proceso. |
...
| **Historias de usuario relacionadas** | HU-004 (Confirmar identidad), HU-005 (Reintentar o corregir el envío del OTP) |
