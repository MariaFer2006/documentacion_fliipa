...
|**Postcondiciones**| Los canales de comunicación del cliente quedan validados mediante ambos mecanismos (WhatsApp y correo electrónico), permitiéndole continuar con el proceso de KYC. |
...
| **Historias de usuario relacionadas** |[HU-004](../../Historias De Usuario/1. Onboarding/HU-004 Confirmar identidad.md) (Confirmar identidad)<br>[HU-005](../../Historias De Usuario/1. Onboarding/HU-005 Reintentar o corregir el env�o del OTP.md) (Reintentar o corregir el envío del OTP) |
| **Estado en plataforma** | Implementado (`send-otp.ts`, `validate-otp.ts`). **Hallazgos de seguridad vigentes**: existe un código comodín hardcodeado que valida cualquier OTP ([RNF-001](../../Requerimientos/Requerimientos No Funcionales.md)), y el canal SMS está simulado — no envía mensajes reales ([RNF-007](../../Requerimientos/Requerimientos No Funcionales.md)). Ambos deben priorizarse antes de producción. | |
| **Referencias** | Fuente: fichas [HU-004](../../Historias De Usuario/1. Onboarding/HU-004 Confirmar identidad.md) (Confirmar identidad),[HU-005](../../Historias De Usuario/1. Onboarding/HU-005 Reintentar o corregir el env�o del OTP.md) (Reintentar o corregir el envío del OTP — *Historias de Usuario — Fliipa*, carpeta "1. Onboarding" (repositorio `documentacion_fliipa`, María Fernanda Herazo). |
