...
| **Relaciones** | Casos de uso:  [CU-026](../../Casos de Uso/4. Cobranza/CU-026 Gestionar debito automatico de creditos vencidos.md). Requerimiento:[RF-022](../../Requerimientos/Requerimientos Funcionales.md). Historia relacionada: [HU-013](../4. Cobranza/HU-013 Prepagar la cuota por PSE.md) . |
