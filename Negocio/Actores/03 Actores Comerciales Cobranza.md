...
| Actor | Rol | Fuente |
|---|---|---|
| Asesor de servicio al cliente (canales digitales) | Realiza la captación de clientes por los canales comerciales digitales definidos (correo, WhatsApp, llamada), presenta la oferta de crédito y acompaña al cliente de forma remota —por chat o llamada— durante el proceso de originación. No realiza visitas presenciales. | Modelo Comercial B2B |
