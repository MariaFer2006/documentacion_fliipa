...
Cada permiso es un *slug* (`PermissionSlug`) agrupado en dos familias: `core:*` (administración del crédito/core bancario) y `product:*` (gestión de producto sobre datos del cliente). Un usuario tiene los permisos base de su rol (ver [01](01 roles del panel administrativo.md)) más cualquier permiso individual otorgado en `extra_permissions`.
