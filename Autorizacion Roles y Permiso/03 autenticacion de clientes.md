...
- Si el estado es `approved`, el cliente es redirigido al flujo de onboarding de redemption (ver [HU-045](../Funcional/Historias%20De%20Usuario/3.%20Credito/HU-045%20Visualizacion%20y%20confirmacion%20del%20cupo%20aprobado.md)).
